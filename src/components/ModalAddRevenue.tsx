...
const ModalAddRevenue: React.FC<ModalAddRevenueProps> = ({ isModalOpen, setIsModalOpen,setListCashFlows, listCashFlows, userLoginId }) => {
    ...
    return(
        <Modal title="Nova Receita" open={isModalOpen} onOk={handleOk} onCancel={handleCancel} bodyStyle={{ overflowY: 'auto', maxHeight: 'calc(100vh - 200px)' }} destroyOnClose>
            <Form
                preserve={false}
                name="new-cashFlow"
                onFinish={onFinish}
            ...
            >
                ...
                <Form.Item name={['cashFlow', 'transactionDate']} label="Data de Entrada" rules={[{ required: true }]}>
